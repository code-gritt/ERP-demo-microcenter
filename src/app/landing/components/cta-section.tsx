                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-muted-foreground mx-auto max-w-2xl text-balance lg:text-xl">
                                    Manage finance, HR, inventory, and projects all in one place.
                                    Experience real-time insights, automation, and collaboration
                                    with our modern ERP platform.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-center gap-4 sm:flex-row sm:gap-6">
                                ...
                                >
                                    <a href="/auth/sign-up">
                                        <Database className="me-2 size-5" />
                                        Try ERP Demo
                                    </a>
                                </Button>
                                <Button
                            ...
                            <div className="text-muted-foreground flex flex-wrap items-center justify-center gap-6 text-sm">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>All-in-one ERP platform</span>
                                </div>
                                <div className="flex items-center gap-2">
